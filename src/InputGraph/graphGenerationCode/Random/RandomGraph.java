...
// TODO Auto-generated constructor stub
    ...
    public static void main(String[] args) {
        ...
        BuildGraph("500m80d2500maxC1minCInput.txt", directory, 500,80,2500,1);
    }
    private static void BuildGraph(String fileName, String directory, int vertices,
                                   int dense, int maxCapacity, int minCapacity)
    {
